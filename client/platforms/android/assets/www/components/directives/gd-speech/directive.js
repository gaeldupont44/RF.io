(function () {
  'use strict';
  var _app;
  _app = angular.module('gd-speech', []);
  _app.service('gdSpeechFactory', [
    '$rootScope',
    function ($rootScope) {
  ...
  _app.directive('gdSpeech', [
    ...
    function (gdSpeechFactory) {
      return {
        ...
        scope: { ngModel: '=' },
        template:
            '<div class="gdSpeechFactory-container">' +
              '<a href="" class="gdSpeechFactory-btn" ng-click="toggleStartStop()">' +
                '<i class="icon ion-android-microphone-off" ng-hide="ngModel.recognizing"></i>' +
                '<i class="icon ion-android-microphone" ng-show="ngModel.recognizing"></i>' +
              '</a>' +
              '<p ng-bind-html="speech.msg"></p>' +
              '<div class="gdSpeechFactory-popin">' +
              '</div>' +
            '</div>',
